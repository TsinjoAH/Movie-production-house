...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <script>
        ...
        function searchScene() {
            var formData = {
                sceneNumber : $("#scene-number").val(),
                movieSet : { id : $("#movie-set").val() },
                movieCharacter : { id : $("#actor").val() }
            };

            $.ajax({
                type : "POST",
                contentType : "application/json",
                url : "${pageContext.request.contextPath}/scenes-ajax?begin="+$("#ideal-hour-min").val()+"&end="+$("#ideal-hour-max").val(),
